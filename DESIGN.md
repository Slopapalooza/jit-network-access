...
**Targets:** Engine-agnostic protocol + portable core · **BunkerWeb 1.6.x** as the flagship enforcement adapter (verified against v1.6.13 source; running on 1.6.13) · Chromium **Manifest V3** extension
...
- `label` — human-readable ("Ops – work laptop"), server-side only.
